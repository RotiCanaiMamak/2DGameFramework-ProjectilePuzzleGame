...
void Level2::initialize() {
    ...
    D3DXVECTOR3 ballspos[] = {
        D3DXVECTOR3(600, 1000, 0),
        D3DXVECTOR3(600, 800, 0),
        D3DXVECTOR3(600, 600, 0),
        D3DXVECTOR3(700, 1000, 0),
        D3DXVECTOR3(700, 800, 0),
        D3DXVECTOR3(700, 600, 0),
        D3DXVECTOR3(700, 400, 0),
        D3DXVECTOR3(800, 1000, 0),
        D3DXVECTOR3(800, 800, 0),
        D3DXVECTOR3(800, 600, 0),
        D3DXVECTOR3(800, 400, 0),
        D3DXVECTOR3(800, 200, 0),
        D3DXVECTOR3(1150, 1000, 0),
        D3DXVECTOR3(1150, 800, 0),
        D3DXVECTOR3(1150, 600, 0),
        D3DXVECTOR3(1150, 400, 0),
        D3DXVECTOR3(1150, 200, 0),
        D3DXVECTOR3(1150, 0, 0),
        D3DXVECTOR3(1500, 1000, 0),
        D3DXVECTOR3(1500, 800, 0),
        D3DXVECTOR3(1500, 600, 0),
        D3DXVECTOR3(1500, 400, 0),
        D3DXVECTOR3(1500, 200, 0),
        D3DXVECTOR3(1600, 1000, 0),
        D3DXVECTOR3(1600, 800, 0),
        D3DXVECTOR3(1600, 600, 0),
        D3DXVECTOR3(1600, 400, 0),
        D3DXVECTOR3(1700, 1000, 0),
        D3DXVECTOR3(1700, 800, 0),
        D3DXVECTOR3(1700, 600, 0),
    };
    for (int i = 0; i < sizeof(ballspos) / sizeof(ballspos[0]); i++) { //sizeof(ballspos): total bytes of the array
        GameObject* woodenBall = new GameObject(                            //sizeof(ballspos[0]):size of one element
            0, 0,
            1, 1,
            72, 72,
            90, 177,
    ...
    D3DXVECTOR3 pigspos[] = {
    D3DXVECTOR3(900, 1000, 0),
    D3DXVECTOR3(900, 800, 0),
    D3DXVECTOR3(1000, 1000, 0),
    D3DXVECTOR3(1000, 800, 0),
    D3DXVECTOR3(1400, 1000, 0),
    D3DXVECTOR3(1400, 800, 0),
    D3DXVECTOR3(1300, 1000, 0),
    D3DXVECTOR3(1300, 800, 0),
    };
    for (int i = 0; i < sizeof(pigspos) / sizeof(pigspos[0]); i++) {
        Pig* pig = new Pig(
            0, 0,
            3, 2,
            80, 80,
